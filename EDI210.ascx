...
<table>
    ...
    <tr>
        <td colspan="4">If X12 is chosen, the following section will appear
        </td>
    </tr>
    <tr>
        <td class="Column1"></td>
    ...
    <tr>
        <td colspan="4">If any FTP option is chosen, the following section will appear
        </td>
    </tr>
    <tr>
        <td class="Column1"></td>
    ...
    <tr>
     ...
     <tr>
        <td colspan="4">If email is chosen, the following section will appear
        </td>
    </tr>
    <tr>
        <td class="Column1"></td>
