<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditRequestType.ascx.cs" Inherits="EditRequestType" %>
    ...
    <table>
        ...
        <tr>
            <td style="width: 30px; color:red; text-align:right " ></td>
             <td ><asp:Label ID="lblRequestTypeID" runat="server" CssClass="rdfLabel" Text="ID" />
            </td>
            <td>
                <asp:Label ID="idRequestType" runat="server" CssClass="rdfLabel" Text='<%# Bind("idRequestType") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblRequestType" runat="server" CssClass="rdfLabel" Text="Request Type" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtRequestType" runat="server" Text='<%# Bind("RequestType") %>'  Width="300px" ToolTip="Enter the Request Type"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtRequestType" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
