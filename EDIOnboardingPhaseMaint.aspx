...
<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EDIOnboardingPhaseMaint.aspx.cs" Inherits="EDIOnboardingPhaseMaint" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idEDIOnboardingPhase">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EDIOnboardPhaseEdit.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idEDIOnboardingPhase" FilterControlAltText="Filter idEDIOnboardingPhase column" HeaderText="idEDIOnboardingPhase" SortExpression="idEDIOnboardingPhase" UniqueName="idEDIOnboardingPhase">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="EDIOnboardingPhaseType" AllowFiltering="true" FilterControlAltText="Filter EDIOnboardingPhaseType column" HeaderText="EDIOnboardingPhaseType" SortExpression="EDIOnboardingPhaseType" UniqueName="EDIOnboardingPhaseType">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="SortValue" FilterControlAltText="Filter SortValue column" HeaderText="SortValue" SortExpression="SortValue" UniqueName="SortValue">
                    </telerik:GridBoundColumn>
