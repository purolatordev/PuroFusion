...
public partial class rptCustomerDelay : System.Web.UI.Page
{
    ...
    protected void loadData()
    {
        ...
        try
        {
            cmd = new SqlCommand("sp_CustomerDelayReport", cnn);
            ...
            LocalReport r = new LocalReport();
            r.ReportPath = Server.MapPath("~/rptCustomerDelay.rdlc");
            r.DataSources.Add(rptData);

            ReportViewer1.LocalReport.DataSources.Add(rptData);
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rptCustomerDelay.rdlc");
            ReportViewer1.LocalReport.Refresh();
            ReportViewer1.Visible = true;
            ReportViewer1.LocalReport.DisplayName = "CustomerDelayNotes";
