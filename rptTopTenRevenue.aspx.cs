...
public partial class rptTopTenRevenue : System.Web.UI.Page
{
    ...
    protected void initializeData()
    {
        ...
        try
        {
            ...
            r.ReportPath = Server.MapPath("~/rptTopTenRevenue.rdlc");
            r.DataSources.Add(rptData1);

            ReportViewer1.LocalReport.DataSources.Add(rptData1);

            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rptTopTenRevenue.rdlc");
    ...
    private void SetReportParameters()
    {
        ...
        ReportViewer1.LocalReport.DisplayName = "TopTenRevenue";
    }
    ...
    protected void loadData()
    {
        ...
        try
        {
            cmd = new SqlCommand("sp_TopTenRevenue", cnn);
