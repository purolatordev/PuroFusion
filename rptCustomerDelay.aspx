<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="rptCustomerDelay.aspx.cs" Inherits="rptCustomerDelay" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        ...
        <AjaxSettings>
           ...
           <telerik:AjaxSetting AjaxControlID="rddlITBA">
                <UpdatedControls>
                   <telerik:AjaxUpdatedControl ControlID="rddlCustomer" LoadingPanelID="RadAjaxLoadingPanel1" />
                    <telerik:AjaxUpdatedControl ControlID="pnlSuccess" />
                    <telerik:AjaxUpdatedControl ControlID="pnlWarning" />
                    <telerik:AjaxUpdatedControl ControlID="pnlDanger" />
    ...
    <telerik:RadToolTip ID="RadToolTip2" runat="server" Width="200px" ShowEvent="OnClick"
          TargetControlID="HeaderLink" IsClientID="true" HideEvent="LeaveToolTip" Position="Center"
           Animation="Resize" ShowDelay="0" RelativeTo="Element" Text="Notes detailing customer delays during onboarding</p>">
     </telerik:RadToolTip>
    ...
    <br />
        <div id="selectedMenu" style="padding-left:20px"><b>Customer Delay Notes </b>
    <a id="HeaderLink" href="#" onclick="return false;">
       <img src="Images/help-icon16.png" />
    </a>
            <br /><i>Notes detailing customer delays during onboarding </i>
        </div>
    <div>
    ...
    <hr />
        ...
        <table border="0">
            <tr>
                <td><asp:Label ID="Label1" runat="server" Text ="Enter Begin Date" Visible="true"></asp:Label></td>
                <td><telerik:RadDatePicker  runat="server" ID="dpInvoiceDate1" Visible="true"></telerik:RadDatePicker></td>
                <td><asp:Label ID="Label2" runat="server" Text ="Enter End Date" Visible="true"></asp:Label></td>
                <td><telerik:RadDatePicker  runat="server" ID="dpInvoiceDate2" Visible="true"></telerik:RadDatePicker></td>             
                                
           </tr>
              <tr>
                <td>Select Onboarding Specialist</td>
                <td><telerik:RadDropDownList ID="rddlITBA" runat="server" DefaultMessage="Select Onboarding Specialist" ToolTip="Select Onboarding Specialist" Visible="true" OnSelectedIndexChanged="rddlITBA_IndexChanged"  AutoPostBack="true"></telerik:RadDropDownList></td>
                <td></td>
                <td></td>
              ...
              <tr>
                ...
                <td><telerik:RadDropDownList ID="rddlCustomer" runat="server" DefaultMessage="Select Customer" ToolTip="Select Customer" Visible="true" ></telerik:RadDropDownList></td>
                <td></td>
                <td></td>
            ...
            <tr>
                 <td>
                    <telerik:RadButton ButtonType="StandardButton" OnClick="btnSubmit_Click" runat="server" ID="RadButton1" Text="Run Report" ForeColor="Green" Enabled="true" AutoPostBack="true"/>
                </td>    
                <td></td>
                 <td></td>
                 <td></td>
