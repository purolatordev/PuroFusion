<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="rptClosedRequests.aspx.cs" Inherits="rptClosedRequests" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <br />
        <div id="selectedMenu" style="padding-left:20px"><b>Closed Request Report</b>
    <a id="HeaderLink" href="#" onclick="return false;">
       <img src="Images/help-icon16.png" />
    </a>
            <br /><i>Closed Discovery Request Report</i>
        </div>
    <div>
