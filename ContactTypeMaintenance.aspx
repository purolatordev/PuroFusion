<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="ContactTypeMaintenance.aspx.cs" Inherits="ContactTypeMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idContactType">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditContactType.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idContactType" FilterControlAltText="Filter idContactType column" HeaderText="idContactType" SortExpression="idContactType" UniqueName="idContactType">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="ContactType" AllowFiltering="true" FilterControlAltText="Filter ContactType column" HeaderText="Contact Type" SortExpression="ContactType" UniqueName="ContactType">
                    </telerik:GridBoundColumn>
