<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CustomsTypeMaintenance.aspx.cs" Inherits="CustomsTypeMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <telerik:RadAjaxManager ID="RadAjaxManager1" runat="server">
        ...
        <AjaxSettings>
            <telerik:AjaxSetting AjaxControlID="rgCustoms">
                <UpdatedControls>
                    <telerik:AjaxUpdatedControl ControlID="rgCustoms" LoadingPanelID="RadAjaxLoadingPanel1" />
    ...
    <div>
       <telerik:RadGrid ID="rgCustoms" runat="server" CellSpacing="-1" GridLines="Both" GroupPanelPosition="Top" ShowFooter="True" 
            OnNeedDataSource="rgCustoms_NeedDataSource" AllowFilteringByColumn="True" OnItemCommand="rgCustoms_ItemCommand"
             OnInsertCommand="rgCustoms_InsertCommand" OnUpdateCommand="rgCustoms_UpdateCommand"
             AllowSorting="true">
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idCustomsType">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditCustomsType.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idCustomsType" FilterControlAltText="Filter idCustomsType column" HeaderText="idCustomsType" SortExpression="idCustomsType" UniqueName="idCustomsType">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="CustomsType" AllowFiltering="true" FilterControlAltText="Filter CustomsType column" HeaderText="Customs Type" SortExpression="CustomsType" UniqueName="CustomsType">
                    </telerik:GridBoundColumn>
