...
public partial class InductionPointMaintenance : System.Web.UI.Page
{
    PuroTouchSQLDataContext puroTouchContext = new PuroTouchSQLDataContext();
    ClsInductionPoint cls = new ClsInductionPoint();
    ...
    {
        List<ClsInductionPoint> dataList = rep.GetInductionPoints();
    ...
    protected void rgGrid_ItemCommand(object sender, Telerik.Web.UI.GridCommandEventArgs e)
    {
        ...
        {
            rgGrid.ExportSettings.FileName = "InductionPoints";
