<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="FreightAuditMaintenance.aspx.cs" Inherits="FreightAuditMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idFreightAuditor" PageSize="25">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditAuditor.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idFreightAuditor" FilterControlAltText="Filter idFreightAuditor column" HeaderText="Freight Auditor ID" SortExpression="idFreightAuditor" UniqueName="idFreightAuditor">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="CompanyName" AllowFiltering="true" FilterControlAltText="Filter CompanyName column" HeaderText="Company Name" SortExpression="CompanyName" UniqueName="CompanyName">
                    </telerik:GridBoundColumn>
