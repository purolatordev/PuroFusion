<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BillingSpecMaintEdit.ascx.cs" Inherits="BillingSpecMaintEdit" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
    ...
    <table border="0">
        ...
        <tr>
            ...
            <td style="width: 150px;">
                <b>Billing Specialist Maintenance </b>
            </td>
    ...
    <table>
        <tr>
            ...
            <asp:HiddenField ID="hdnITBAID" runat="server" Value='<%# Bind("idBillingSpecialist") %>' />
            <td>
                <asp:Label ID="lblITBA" runat="server" CssClass="rdfLabel" Text="Billing Speicialst" />
            </td>
            <td>
