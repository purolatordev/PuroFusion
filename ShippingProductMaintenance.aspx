<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ShippingProductMaintenance.aspx.cs" Inherits="ShippingProductMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idShippingProduct">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditShippingProduct.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idShippingProduct" FilterControlAltText="Filter idShippingProduct column" HeaderText="idShippingProduct" SortExpression="idShippingProduct" UniqueName="idShippingProduct">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="ShippingProduct" AllowFiltering="true" FilterControlAltText="Filter ShippingProduct column" HeaderText="Shipping Product" SortExpression="ShippingProduct" UniqueName="ShippingProduct">
                    </telerik:GridBoundColumn>
                     <telerik:GridBoundColumn DataField="ShippingService" AllowFiltering="true" FilterControlAltText="Filter ShippingService column" HeaderText="Shipping Service" SortExpression="ShippingService" UniqueName="ShippingService">
                    </telerik:GridBoundColumn>
