...
public partial class scheduledGoLive : System.Web.UI.Page
{
    ...
    protected void rgGrid_NeedDataSource(object sender, GridNeedDataSourceEventArgs e)
    {
        ...
        try
        {
            cmd = new SqlCommand("sp_scheduledGoLive", cnn);
    ...
    protected void rgGrid_ItemCreated(object sender, Telerik.Web.UI.GridItemEventArgs e)
    {
        ...
        if (e.Item is GridFilteringItem)
        {
            ...
            if (item != null)
            {
                ...
                LiteralControl literalTo1 = item["TargetGoLive"].Controls[3] as LiteralControl;
