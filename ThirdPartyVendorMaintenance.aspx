<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ThirdPartyVendorMaintenance.aspx.cs" Inherits="ThirdPartyVendorMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idThirdPartyVendor">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditVendor.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idThirdPartyVendor" FilterControlAltText="Filter idThirdPartyVendor column" HeaderText="idThirdPartyVendor" SortExpression="idThirdPartyVendor" UniqueName="idThirdPartyVendor">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="VendorName" AllowFiltering="true" FilterControlAltText="Filter VendorName column" HeaderText="VendorName" SortExpression="VendorName" UniqueName="VendorName">
                    </telerik:GridBoundColumn>
