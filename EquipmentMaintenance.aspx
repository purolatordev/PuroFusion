<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EquipmentMaintenance.aspx.cs" Inherits="EquipmentMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idEquipment">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditEquipment.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idEquipment" FilterControlAltText="Filter idEquipment column" HeaderText="idEquipment" SortExpression="idEquipment" UniqueName="idEquipment">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="Equipment" AllowFiltering="true" FilterControlAltText="Filter Equipment column" HeaderText="Equipment" SortExpression="Equipment" UniqueName="Equipment">
                    </telerik:GridBoundColumn>
