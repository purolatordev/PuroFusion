<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditEDISolution.ascx.cs" Inherits="EditEDISolution" %>
...
<telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="txtVendor">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="txtEDISolution"  LoadingPanelID="RadAjaxLoadingPanel1" />
            </UpdatedControls>
        </telerik:AjaxSetting>
    </AjaxSettings>
    ...
    <table>
        ...
        <tr>
            <td style="width: 30px; color:red; text-align:right " ></td>
             <td ><asp:Label ID="lblEDISolutionID" runat="server" CssClass="rdfLabel" Text="ID" />
            </td>
            <td>
                <asp:Label ID="idSolution" runat="server" CssClass="rdfLabel" Text='<%# Bind("idSolution") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblSolution" runat="server" CssClass="rdfLabel" Text="EDI Solution" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtSolution" runat="server" Text='<%# Bind("Solution") %>'  Width="300px" ToolTip="Enter the EDI Solution"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtSolution" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
