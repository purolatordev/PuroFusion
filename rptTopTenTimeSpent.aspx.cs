...
public partial class rptTopTenTimeSpent : System.Web.UI.Page
{
    ...
    protected void initializeData()
    {
        ...
        try
        {
            ...
            r.ReportPath = Server.MapPath("~/rptTopTenTimeSpent.rdlc");
            r.DataSources.Add(rptData1);

            ReportViewer1.LocalReport.DataSources.Add(rptData1);

            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rptTopTenTimeSpent.rdlc");
    ...
    private void SetReportParameters()
    {
        ...
        ReportViewer1.LocalReport.DisplayName = "TopTenTimeSpent";
    }
    ...
    protected void loadData()
    {
        ...
        try
        {
            cmd = new SqlCommand("sp_TopTenTimeSpent", cnn);
