<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditContactType.ascx.cs" Inherits="EditContactType" %>
...
<telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="txtCloseReason">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="txtContactType"  LoadingPanelID="RadAjaxLoadingPanel1" />
            </UpdatedControls>
        </telerik:AjaxSetting>
    </AjaxSettings>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblContactTypeID" runat="server" CssClass="rdfLabel" Text='<%# Bind("idContactType") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblContactType" runat="server" CssClass="rdfLabel" Text="Contact Type" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtContactType" runat="server" Text='<%# Bind("ContactType") %>'  Width="300px" ToolTip="Enter the Contact Type"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtContactType" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
