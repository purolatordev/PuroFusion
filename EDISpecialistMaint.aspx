<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EDISpecialistMaint.aspx.cs" Inherits="EDISpecialistMaint" %>
...
<telerik:RadAjaxPanel ID="pnlSuccess" runat="server" Visible="false" >
      ...
      <telerik:RadAjaxPanel ID="pnlDanger" runat="server" Visible="false" >
       ...
       <telerik:RadSkinManager ID="RadSkinManager1" runat="server" ShowChooser="false" />
         ...
         <p></p><div><b>EDI Speicialst Maintenance</b>
                 <a id="HeaderLink1" href="#" onclick="return false;"><img src="Images/help-icon16.png" /></a>
                 <br /><i>Use the EDI Speicialst Maintenance Screen to maintain the list of  Onboarding Speicialsts</i>
                 <hr />
               </div>        
       ...
       <%-- begin maintenance--%>
         ...
         <telerik:RadGrid ID="rgITBA" runat="server" GridLines="Both" CellSpacing="-1" AllowFilteringByColumn="true" OnNeedDataSource="rgITBA_NeedDataSource" 
            ...
            <MasterTableView AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" AllowFilteringByColumn="true" CommandItemDisplay="Top" TableLayout="Fixed" DataKeyNames="idEDISpecialist">
                <CommandItemSettings ShowAddNewRecordButton="True" ShowRefreshButton="False" ShowExportToExcelButton="True"></CommandItemSettings>
                <EditFormSettings UserControlName="EDISpecMaintEdit.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="450px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idEDISpecialist" Visible="false" FilterControlAltText="Filter idEDISpecialist column" HeaderText="idEDISpecialist" SortExpression="idEDISpecialist" UniqueName="idEDISpecialist">
