<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditVendor.ascx.cs" Inherits="EditVendor" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblVendorID" runat="server" CssClass="rdfLabel" Text='<%# Bind("idThirdPartyVendor") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblVendor" runat="server" CssClass="rdfLabel" Text="Vendor" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtVendor" runat="server" Text='<%# Bind("VendorName") %>'  Width="300px" ToolTip="Enter the Vendor Name"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtVendor" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
