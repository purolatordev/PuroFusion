<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditStatusCodes.ascx.cs" Inherits="EditStatusCodes" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblShippingVendorID" runat="server" CssClass="rdfLabel" Text='<%# Bind("idStatusCodes") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
