<%@ Page Language="C#" AutoEventWireup="true"  MasterPageFile="~/Site.master" CodeFile="rptTimePerShippingChannel.aspx.cs" Inherits="rptTimePerShippingChannel" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <telerik:RadToolTip ID="RadToolTip2" runat="server" Width="200px" ShowEvent="OnClick"
          TargetControlID="HeaderLink" IsClientID="true" HideEvent="LeaveToolTip" Position="Center"
           Animation="Resize" ShowDelay="0" RelativeTo="Element" Text="Time Spent Per Onboarding Phase</p>">
     </telerik:RadToolTip>
    ...
    <br />
        <div id="selectedMenu" style="padding-left:20px"><b>Onboarding Time by Shipping Channel</b>
    <a id="HeaderLink" href="#" onclick="return false;">
       <img src="Images/help-icon16.png" />
    </a>
            <br /><i>Onboarding Time Spent by Shipping Channel</i>
        </div>
    <div>
    ...
    <hr />
        ...
        <table border="0">
         ...
         <LocalReport ReportPath="rptTimePerShippingChannel.rdlc">
             <DataSources>
