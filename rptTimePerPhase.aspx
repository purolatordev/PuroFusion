<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="rptTimePerPhase.aspx.cs" Inherits="rptTimePerPhase" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <br />
        <div id="selectedMenu" style="padding-left:20px"><b>Onboarding Time Per Phase</b>
    <a id="HeaderLink" href="#" onclick="return false;">
       <img src="Images/help-icon16.png" />
    </a>
            <br /><i>Time Spent Per Onboarding Phase</i>
        </div>
    <div>
