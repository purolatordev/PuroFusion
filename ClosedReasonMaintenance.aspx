<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ClosedReasonMaintenance.aspx.cs" Inherits="ClosedReasonMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idCloseReason">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditCloseReason.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idCloseReason" FilterControlAltText="Filter idCloseReason column" HeaderText="idCloseReason" SortExpression="idCloseReason" UniqueName="idCloseReason">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="CloseReason" AllowFiltering="true" FilterControlAltText="Filter CloseReason column" HeaderText="Close Reason" SortExpression="CloseReason" UniqueName="CloseReason">
                    </telerik:GridBoundColumn>
