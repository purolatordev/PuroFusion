<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditShippingChannel.ascx.cs" Inherits="EditShippingChannel" %>
         ...
         <tr>
            ...
            <tr>
                ...
                <td style="width: 250px;">
                    <b>Shipping Channel Maintenance </b>
    ...
    <table>
        ...
        <tr>
            <td style="width: 30px; color:red; text-align:right " ></td>
             <td ><asp:Label ID="lblShippingChannelID" runat="server" CssClass="rdfLabel" Text="ID" />
            </td>
            <td>
                <asp:Label ID="idShippingChannel" runat="server" CssClass="rdfLabel" Text='<%# Bind("idShippingChannel") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblShippingChannel" runat="server" CssClass="rdfLabel" Text="Shipping Channel" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtShippingChannel" runat="server" Text='<%# Bind("ShippingChannel") %>'  Width="300px" ToolTip="Enter the Shipping Channel"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtShippingChannel" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
