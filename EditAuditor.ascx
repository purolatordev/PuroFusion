<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditAuditor.ascx.cs" Inherits="EditAuditor" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
         ...
         <tr>
            ...
            <tr>
                ...
                <td style="width: 250px;">
                    <b>Freight Auditor Maintenance </b>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblVendorTypeID" runat="server" CssClass="rdfLabel" Text='<%# Bind("idFreightAuditor") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblVendorType" runat="server" CssClass="rdfLabel" Text="Freight Auditor" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtVendorType" runat="server" Text='<%# Bind("CompanyName") %>'  Width="300px" ToolTip="Enter the Freight Auditor"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
