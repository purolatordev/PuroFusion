<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditShippingService.ascx.cs" Inherits="EditShippingService" %>
    ...
    <table>
        ...
        <tr>
            <td style="width: 30px; color:red; text-align:right " ></td>
             <td ><asp:Label ID="lblShippingSvcID" runat="server" CssClass="rdfLabel" Text="ID" />
            </td>
            <td>
                <asp:Label ID="idShippingSvc" runat="server" CssClass="rdfLabel" Text='<%# Bind("idShippingSvc") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblserviceDesc" runat="server" CssClass="rdfLabel" Text="Service Description" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtServiceDesc" runat="server" Text='<%# Bind("serviceDesc") %>'  Width="300px" ToolTip="Enter the Service Description"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtServiceDesc" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
