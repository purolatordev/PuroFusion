<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditCustomsType.ascx.cs" Inherits="EditCustomsType" %>
...
<telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="txtCustomsType">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="txtCustomsType"  LoadingPanelID="RadAjaxLoadingPanel1" />
            </UpdatedControls>
        </telerik:AjaxSetting>
    </AjaxSettings>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblCustomsTypeID" runat="server" CssClass="rdfLabel" Text='<%# Bind("idCustomsType") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblCustomsType" runat="server" CssClass="rdfLabel" Text="Customs Type" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtCustomsType" runat="server" Text='<%# Bind("CustomsType") %>'  Width="300px" ToolTip="Enter the Customs Type" MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtCustomsType" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
