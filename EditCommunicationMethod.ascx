<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditCommunicationMethod.ascx.cs" Inherits="EditCommunicationMethod" %>
...
<telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="txtVendor">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="txtVendor"  LoadingPanelID="RadAjaxLoadingPanel1" />
            </UpdatedControls>
        </telerik:AjaxSetting>
    </AjaxSettings>
    ...
    <table>
        ...
        <tr>
            <td style="width: 30px; color:red; text-align:right " ></td>
             <td ><asp:Label ID="lblCommunicationMethodID" runat="server" CssClass="rdfLabel" Text="ID" />
            </td>
            <td>
                <asp:Label ID="idCommunicationMethod" runat="server" CssClass="rdfLabel" Text='<%# Bind("idCommunicationMethod") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblCommunicationMethod" runat="server" CssClass="rdfLabel" Text="Communication Method" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtCommunicationMethod" runat="server" Text='<%# Bind("CommunicationMethod") %>'  Width="300px" ToolTip="Enter the Communication Method"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtCommunicationMethod" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
