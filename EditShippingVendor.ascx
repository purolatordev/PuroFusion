<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditShippingVendor.ascx.cs" Inherits="EditShippingVendor" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
         ...
         <tr>
            ...
            <tr>
                ...
                <td style="width: 250px;">
                    <b>Shipping Vendor Maintenance </b>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblShippingVendorID" runat="server" CssClass="rdfLabel" Text='<%# Bind("idShippingVendor") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblVendorName" runat="server" CssClass="rdfLabel" Text="Vendor Name" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtVendorName" runat="server" Text='<%# Bind("VendorName") %>'  Width="300px" ToolTip="Enter the Vendor Name"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
