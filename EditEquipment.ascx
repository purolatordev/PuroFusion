<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditEquipment.ascx.cs" Inherits="EditEquipment" %>
...
<telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="txtEquipment">
            <UpdatedControls>
                <telerik:AjaxUpdatedControl ControlID="txtEquipment"  LoadingPanelID="RadAjaxLoadingPanel1" />
            </UpdatedControls>
        </telerik:AjaxSetting>
    </AjaxSettings>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblEquipmentID" runat="server" CssClass="rdfLabel" Text='<%# Bind("idEquipment") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblEquipment" runat="server" CssClass="rdfLabel" Text="Equipment" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtEquipment" runat="server" Text='<%# Bind("Equipment") %>'  Width="300px" ToolTip="Enter the Equipment Description"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtEquipment" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
