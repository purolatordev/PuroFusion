<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="VendorTypeMaintenance.aspx.cs" Inherits="VendorTypeMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idVendorType" PageSize="25">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditVendorType.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idVendorType" FilterControlAltText="Filter idVendorType column" HeaderText="idVendorType" SortExpression="idVendorType" UniqueName="idVendorType">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="VendorType" AllowFiltering="true" FilterControlAltText="Filter VendorType column" HeaderText="VendorType" SortExpression="VendorType" UniqueName="VendorType">
                    </telerik:GridBoundColumn>
