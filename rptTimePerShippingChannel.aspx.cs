...
public partial class rptTimePerShippingChannel : System.Web.UI.Page
{
    ...
    protected void initializeData()
    {
        ...
        try
        {
            ...
            r.ReportPath = Server.MapPath("~/rptTimePerShippingChannel.rdlc");
            r.DataSources.Add(rptData1);

            ReportViewer1.LocalReport.DataSources.Add(rptData1);

            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rptTimePerShippingChannel.rdlc");
    ...
    private void SetReportParameters()
    {
        ...
        ReportViewer1.LocalReport.DisplayName = "TimePerShippingChannel";
    }
    ...
    protected void loadData()
    {
        ...
        try
        {
            cmd = new SqlCommand("sp_OnboardingTimePerShippingChannel", cnn);
