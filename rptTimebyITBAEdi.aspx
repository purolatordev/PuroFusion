<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="rptTimebyITBAEdi.aspx.cs" Inherits="rptTimebyITBAEdi" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <telerik:RadToolTip ID="RadToolTip2" runat="server" Width="200px" ShowEvent="OnClick"
        ...
        Animation="Resize" ShowDelay="0" RelativeTo="Element" Text="Total Time Spent per ITBA as recorded in Discovery Request Notes">
    </telerik:RadToolTip>
    ...
    <div>
        ...
        <table border="0">
            <tr>
                ...
                <td>
                    <telerik:RadDatePicker runat="server" ID="dpInvoiceDate1"></telerik:RadDatePicker>
                </td>
                <td>Enter End Date</td>
                <td>
                    <telerik:RadDatePicker runat="server" ID="dpInvoiceDate2"></telerik:RadDatePicker>
                </td>
            </tr>
            <tr>
