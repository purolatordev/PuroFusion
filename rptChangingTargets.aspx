<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.master" CodeFile="rptChangingTargets.aspx.cs" Inherits="rptChangingTargets" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <telerik:RadToolTip ID="RadToolTip2" runat="server" Width="200px" ShowEvent="OnClick"
          TargetControlID="HeaderLink" IsClientID="true" HideEvent="LeaveToolTip" Position="Center"
           Animation="Resize" ShowDelay="0" RelativeTo="Element" Text="Closed Discovery Request Report</p>">
     </telerik:RadToolTip>
    ...
    <br />
        <div id="selectedMenu" style="padding-left:20px"><b>Changing Target Dates Report</b>
    <a id="HeaderLink" href="#" onclick="return false;">
       <img src="Images/help-icon16.png" />
    </a>
            <br /><i>Changing Target Dates Report</i>
        </div>
    <div>
    ...
    <hr />
        ...
        <table border="0">
         ...
         <LocalReport ReportPath="TargetReport.rdlc">
             <DataSources>
