<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EDISolutionsMaintenance.aspx.cs" Inherits="EDISolutionsMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idSolution">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditEDISolution.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idSolution" FilterControlAltText="Filter idSolution column" HeaderText="idSolution" SortExpression="idSolution" UniqueName="idSolution">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="Solution" AllowFiltering="true" FilterControlAltText="Filter Solution column" HeaderText="Solution" SortExpression="Solution" UniqueName="Solution">
                    </telerik:GridBoundColumn>
