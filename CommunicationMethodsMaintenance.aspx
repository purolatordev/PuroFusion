<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CommunicationMethodsMaintenance.aspx.cs" Inherits="CommunicationMethodsMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idCommunicationMethod">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditCommunicationMethod.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idCommunicationMethod" FilterControlAltText="Filter idCommunicationMethod column" HeaderText="idCommunicationMethod" SortExpression="idCommunicationMethod" UniqueName="idCommunicationMethod">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="CommunicationMethod" AllowFiltering="true" FilterControlAltText="Filter CommunicationMethod column" HeaderText="Communication Method" SortExpression="CommunicationMethod" UniqueName="CommunicationMethod">
                    </telerik:GridBoundColumn>
