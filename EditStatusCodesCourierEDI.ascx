<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditStatusCodesCourierEDI.ascx.cs" Inherits="EditStatusCodesCourierEDI" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
         ...
         <tr>
            ...
            <tr>
                ...
                <td style="width: 250px;">
                    <b>Status Codes Courier EDI Maintenance </b>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblShippingVendorID" runat="server" CssClass="rdfLabel" Text='<%# Bind("idStatusCodesCourierEDI") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
