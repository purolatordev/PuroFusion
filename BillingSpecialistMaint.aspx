<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="BillingSpecialistMaint.aspx.cs" Inherits="BillingSpecialistMaint" %>
...
<telerik:RadAjaxPanel ID="pnlSuccess" runat="server" Visible="false" >
      ...
      <telerik:RadAjaxPanel ID="pnlDanger" runat="server" Visible="false" >
       ...
       <telerik:RadSkinManager ID="RadSkinManager1" runat="server" ShowChooser="false" />
         ...
         <p></p><div><b>Billing Speicialst Maintenance</b>
                 <a id="HeaderLink1" href="#" onclick="return false;"><img src="Images/help-icon16.png" /></a>
                 <br /><i>Use the Billing Speicialst Maintenance Screen to maintain the list of  Billing Speicialsts</i>
                 <hr />
               </div>        
       ...
       <%-- begin maintenance--%>
         ...
         <telerik:RadGrid ID="rgITBA" runat="server" GridLines="Both" CellSpacing="-1" AllowFilteringByColumn="true" OnNeedDataSource="rgITBA_NeedDataSource" 
            ...
            <MasterTableView AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" AllowFilteringByColumn="true" CommandItemDisplay="Top" TableLayout="Fixed" DataKeyNames="idBillingSpecialist">
                <CommandItemSettings ShowAddNewRecordButton="True" ShowRefreshButton="False" ShowExportToExcelButton="True"></CommandItemSettings>
                <EditFormSettings UserControlName="BillingSpecMaintEdit.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="450px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idBillingSpecialist" Visible="false" FilterControlAltText="Filter idBillingSpecialist column" HeaderText="idBillingSpecialist" SortExpression="idBillingSpecialist" UniqueName="idBillingSpecialist">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="Name" FilterControlAltText="Filter Name column" HeaderText="EDI Speicialst Name" SortExpression="Name" UniqueName="Name">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="email" FilterControlAltText="Filter Email column" HeaderText="EDI Speicialst Email" SortExpression="email" UniqueName="email">
                    </telerik:GridBoundColumn>
                    ...
                    Resizable="false" ConfirmText="Remove From EDI List?" Visible="false">
