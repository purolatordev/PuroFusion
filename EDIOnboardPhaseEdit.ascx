<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EDIOnboardPhaseEdit.ascx.cs" Inherits="EDIOnboardPhaseEdit" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
         ...
         <tr>
            ...
            <tr>
                ...
                <td style="width: 250px;">
                    <b>EDI Onboarding Phase Maintenance </b>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblOnboardingPhaseID" runat="server" CssClass="rdfLabel" Text='<%# Bind("idEDIOnboardingPhase") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            ...
            <td>
                <telerik:RadTextBox ID="txtOnboardingPhase" runat="server" Text='<%# Bind("EDIOnboardingPhaseType") %>'  Width="300px" ToolTip="Enter the Onboarding Phase"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
