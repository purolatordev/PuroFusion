<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ShippingServicesMaintenance.aspx.cs" Inherits="ShippingServicesMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idShippingSvc">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditShippingService.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idShippingSvc" FilterControlAltText="Filter idShippingSvc column" HeaderText="idShippingSvc" SortExpression="idShippingSvc" UniqueName="idShippingSvc">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="ServiceDesc" AllowFiltering="true" FilterControlAltText="Filter ServiceDesc column" HeaderText="Service Description" SortExpression="ServiceDesc" UniqueName="ServiceDesc">
                    </telerik:GridBoundColumn>
