<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="rptTimePerCustomer.aspx.cs" Inherits="rptTimePerCustomer" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <telerik:RadToolTip ID="RadToolTip2" runat="server" Width="200px" ShowEvent="OnClick"
          TargetControlID="HeaderLink" IsClientID="true" HideEvent="LeaveToolTip" Position="Center"
           Animation="Resize" ShowDelay="0" RelativeTo="Element" Text="Onboarding Time Spent Per Customer</p>">
     </telerik:RadToolTip>
    ...
    <br />
        <div id="selectedMenu" style="padding-left:20px"><b>Onboarding Time Per Customer</b>
    <a id="HeaderLink" href="#" onclick="return false;">
       <img src="Images/help-icon16.png" />
    </a>
            <br /><i>Onboarding Time Spent Per Customer</i>
        </div>
    <div>
