<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EDISpecMaintEdit.ascx.cs" Inherits="EDISpecMaintEdit" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
    ...
    <table border="0">
        ...
        <tr>
            ...
            <td style="width: 150px;">
                <b>EDI Specialist Maintenance </b>
            </td>
    ...
    <table>
        <tr>
            ...
            <asp:HiddenField ID="hdnITBAID" runat="server" Value='<%# Bind("idEDISpecialist") %>' />
            <td>
                <asp:Label ID="lblITBA" runat="server" CssClass="rdfLabel" Text="EDI Speicialst" />
            </td>
            <td>
