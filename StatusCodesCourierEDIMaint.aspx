<%@ Page Language="C#"  MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="StatusCodesCourierEDIMaint.aspx.cs" Inherits="StatusCodesCourierEDIMaint" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idStatusCodesCourierEDI">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditStatusCodesCourierEDI.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idStatusCodesCourierEDI" FilterControlAltText="Filter idStatusCodesCourierEDI column" HeaderText="idStatusCodesCourierEDI" SortExpression="idStatusCodesCourierEDI" UniqueName="idStatusCodesCourierEDI">
