<%@ Page Language="C#"  MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="CollectionSpecialistMaint.aspx.cs" Inherits="CollectionSpecialistMaint" %>
      ...
      <telerik:RadAjaxPanel ID="pnlDanger" runat="server" Visible="false" >
       ...
       <%-- begin maintenance--%>
         ...
         <telerik:RadGrid ID="rgITBA" runat="server" GridLines="Both" CellSpacing="-1" AllowFilteringByColumn="true" OnNeedDataSource="rgITBA_NeedDataSource" 
            ...
            <MasterTableView AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" AllowFilteringByColumn="true" CommandItemDisplay="Top" TableLayout="Fixed" DataKeyNames="idCollectionSpecialist">
                <CommandItemSettings ShowAddNewRecordButton="True" ShowRefreshButton="False" ShowExportToExcelButton="True"></CommandItemSettings>
                <EditFormSettings UserControlName="CollectionSpecMaintEdit.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="450px">
                ...
                <Columns>
                    ...
                    Resizable="false" ConfirmText="Remove From Collection List?" Visible="false">
