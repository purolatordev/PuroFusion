...
public partial class DiscoveryRequestForm2 : System.Web.UI.Page
{
    ...
    protected void displayExistingRequest(Int32 requestID)
    {
        ...
        txtareaCurrentSolution.Text = request.CurrentSolution;
            //Commenting logic for current shipping vendor and flag for now
            //if (request.CurrentlyShippingFlag != null)
            //{
            //     if (request.CurrentlyShippingFlag == true)
            //        rddlCurrentCA.SelectedValue = "Yes";
            //    else
            //         rddlCurrentCA.SelectedValue = "No";
            //}
            //if (request.idShippingVendor != null)
            //{
            //    rddlShippingVendor.SelectedValue = request.idShippingVendor.ToString();
            //    rddlShippingVendor.Visible = true;
            //}            
            //if (rddlShippingVendor.SelectedText.ToLower() == "other")
            //{
            //    txtCurrentVendor.Text = request.OtherVendorName;
            //    txtCurrentVendor.Visible = true;
            //}
        ...
        //{
        //    rdCall1.SelectedDate = request.CallDate1;
        //    btnAddDate1.Enabled = true;
        //}
        //if (request.CallDate2 != null)
        //{
        //    rdCall2.SelectedDate = request.CallDate2;
        ...
        //{
        //    rdCall3.SelectedDate = request.CallDate3;
