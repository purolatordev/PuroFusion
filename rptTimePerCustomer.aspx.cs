...
public partial class rptTimePerCustomer : System.Web.UI.Page
{
    ...
    protected void initializeData()
    {
        ...
        try
        {
            ...
            r.ReportPath = Server.MapPath("~/rptTimePerCustomer.rdlc");
            r.DataSources.Add(rptData1);

            ReportViewer1.LocalReport.DataSources.Add(rptData1);

            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/rptTimePerCustomer.rdlc");
    ...
    private void SetReportParameters()
    {
        ...
        ReportViewer1.LocalReport.DisplayName = "rptTimePerCustomer";
    }
    ...
    protected void loadData()
    {
        ...
        try
        {
            cmd = new SqlCommand("sp_OnboardingTimePerCustomer", cnn);
            ...
            ReportViewer1.LocalReport.Refresh();
            ReportViewer1.Visible = true;
            ReportViewer1.LocalReport.DisplayName = "TimePerCustomer";
