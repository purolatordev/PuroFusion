<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="DataEntryMethodsMaintenance.aspx.cs" Inherits="DataEntryMethodsMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idDataEntry">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditDataEntryMethod.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idDataEntry" FilterControlAltText="Filter idDataEntry column" HeaderText="idDataEntry" SortExpression="idDataEntry" UniqueName="idDataEntry">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="DataEntry" AllowFiltering="true" FilterControlAltText="Filter DataEntry column" HeaderText="Data Entry Method" SortExpression="DataEntry" UniqueName="DataEntry">
                    </telerik:GridBoundColumn>
