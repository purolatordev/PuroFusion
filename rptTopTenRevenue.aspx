<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="rptTopTenRevenue.aspx.cs" Inherits="rptTopTenRevenue" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <telerik:RadToolTip ID="RadToolTip2" runat="server" Width="200px" ShowEvent="OnClick"
          TargetControlID="HeaderLink" IsClientID="true" HideEvent="LeaveToolTip" Position="Center"
           Animation="Resize" ShowDelay="0" RelativeTo="Element" Text="Top Ten Customers by Annualized Projected Revenue</p>">
     </telerik:RadToolTip>
    ...
    <br />
        <div id="selectedMenu" style="padding-left:20px"><b>Top Ten Customers by Projected Revenue</b>
    <a id="HeaderLink" href="#" onclick="return false;">
       <img src="Images/help-icon16.png" />
    </a>
            <br /><i>Top Ten Customers by Annualized Projected Revenue</i>
        </div>
    <div>
