<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="InductionPointMaintenance.aspx.cs" Inherits="InductionPointMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idInduction">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditInductionPoint.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idInduction" FilterControlAltText="Filter idInduction column" HeaderText="idInduction" SortExpression="idInduction" UniqueName="idInduction">
                    ...
                    <telerik:GridBoundColumn DataField="Description" AllowFiltering="true" FilterControlAltText="Filter Description column" HeaderText="Description" SortExpression="Description" UniqueName="Description">
                     ...
                     <telerik:GridBoundColumn DataField="Address" AllowFiltering="true" FilterControlAltText="Filter Address column" HeaderText="Address" SortExpression="Address" UniqueName="Address">
                    </telerik:GridBoundColumn>
                     <telerik:GridBoundColumn DataField="City" AllowFiltering="true" FilterControlAltText="Filter City column" HeaderText="City" SortExpression="City" UniqueName="City">
                    </telerik:GridBoundColumn>
                     <telerik:GridBoundColumn DataField="State" AllowFiltering="true" FilterControlAltText="Filter State column" HeaderText="State" SortExpression="State" UniqueName="State">
                    </telerik:GridBoundColumn>
                     <telerik:GridBoundColumn DataField="Zip" AllowFiltering="true" FilterControlAltText="Filter Zip column" HeaderText="Zip" SortExpression="Zip" UniqueName="Zip">
                    </telerik:GridBoundColumn>
                     <telerik:GridBoundColumn DataField="Country" AllowFiltering="true" FilterControlAltText="Filter Country column" HeaderText="Country" SortExpression="Country" UniqueName="Country">
                    </telerik:GridBoundColumn>
                     <telerik:GridBoundColumn DataField="PuroPostFlag" AllowFiltering="true" FilterControlAltText="Filter PuroPostFlag column" HeaderText="PuroPost Flag" SortExpression="PuroPostFlag" UniqueName="PuroPostFlag">
                    </telerik:GridBoundColumn>
