<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="rptRequestNotes.aspx.cs" Inherits="rptRequestNotes" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <telerik:RadToolTip ID="RadToolTip2" runat="server" Width="200px" ShowEvent="OnClick"
          TargetControlID="HeaderLink" IsClientID="true" HideEvent="LeaveToolTip" Position="Center"
           Animation="Resize" ShowDelay="0" RelativeTo="Element" Text="Onboarding Request Notes Report</p>">
     </telerik:RadToolTip>
    ...
    <br />
        <div id="selectedMenu" style="padding-left:20px"><b>Onboarding Notes </b>
    <a id="HeaderLink" href="#" onclick="return false;">
       <img src="Images/help-icon16.png" />
    </a>
            <br /><i>Onboarding Notes </i>
        </div>
    <div>
    ...
    <hr />
        ...
        <table border="0">
            <tr>
                <td><asp:Label ID="Label1" runat="server" Text ="Enter Begin Date" Visible="false"></asp:Label></td>
                <td><telerik:RadDatePicker  runat="server" ID="dpInvoiceDate1" Visible="false"></telerik:RadDatePicker></td>
                <td><asp:Label ID="Label2" runat="server" Text ="Enter End Date" Visible="false"></asp:Label></td>
                <td><telerik:RadDatePicker  runat="server" ID="dpInvoiceDate2" Visible="false"></telerik:RadDatePicker></td>             
