...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div id="selectedMenu" style="padding-left:20px"><b>Discovery Tracker</b>
    <a id="HeaderLink" href="#" onclick="return false;">
       <img src="Images/help-icon16.png" />
    </a>
            <br /><i>The Discovery Trackers Shows all Current Discovery Requests </i>
        </div><br />
    
    <h5><asp:Label ID="lblGridtitle" runat="server" ForeColor ="Blue" Font-Bold="true" Font-Size="Medium" Visible="true" Text="Discovery Tracker List"></asp:Label></h5>
    <div>
