<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="scheduledGoLiveWithWIP.aspx.cs" Inherits="scheduledGoLiveWithWIP" %>
...
<telerik:RadAjaxPanel ID="pnlSuccess" runat="server" Visible="false" >
      ...
      <telerik:RadAjaxPanel ID="pnlDanger" runat="server" Visible="false" >
       ...
       <telerik:RadSkinManager ID="RadSkinManager1" runat="server" ShowChooser="false" />
         ...
         <telerik:RadToolTip ID="RadToolTip1" runat="server" Width="200px" ShowEvent="OnClick"
          TargetControlID="HeaderLink1" IsClientID="true" HideEvent="LeaveToolTip" Position="Center"
           Animation="Resize" ShowDelay="0" RelativeTo="Element" Text="This report displays the upcoming customers who are scheduled to go live as well as all Work In Progress.">
          </telerik:RadToolTip>

         <p></p><div><b>Scheduled Go-Live and Work In Progress</b>
       ...
       <%-- begin --%>
        ...
        <telerik:RadGrid ID="rgGrid" runat="server" CellSpacing="-1" GridLines="Both" GroupPanelPosition="Top" AllowFilteringByColumn="true" OnNeedDataSource="rgGrid_NeedDataSource" 
            ...
            <ClientSettings >
                <Scrolling AllowScroll="True"  UseStaticHeaders="true" ScrollHeight="500px"></Scrolling>
     ...
     <asp:SqlDataSource ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:PuroTouchDBSQLConnectionString %>"
        ProviderName="System.Data.SqlClient" SelectCommand="select distinct SortValue,OnboardingPhase from tblOnboardingPhase where OnboardingPhase not in ('CLOSED', 'ON HOLD', 'STABILIZATION', 'UNASSIGNED') order by SortValue"
