<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditStatusCodesNonCourierEDI.ascx.cs" Inherits="EditStatusCodesNonCourierEDI" %>
...
<telerik:RadAjaxManagerProxy ID="AjaxManagerProxy1" runat="server">
    <AjaxSettings>
        <telerik:AjaxSetting AjaxControlID="txtVendorName">
            <UpdatedControls>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
         ...
         <tr>
            ...
            <tr>
                ...
                <td style="width: 250px;">
                    <b>Status Codes Non Courier EDI Maintenance </b>
    ...
    <table>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblShippingVendorID" runat="server" CssClass="rdfLabel" Text='<%# Bind("idStatusCodesNonCourierEDI") %>' />
            </td>
        </tr>
        <tr>
            <td style="width: 30px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblVendorName" runat="server" CssClass="rdfLabel" Text="Status Code" />
            </td>
            <td>
                <telerik:RadTextBox ID="txtVendorName" runat="server" Text='<%# Bind("StatusCode") %>'  Width="300px" ToolTip="Enter the Status Code"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
                <asp:RequiredFieldValidator runat="server" ControlToValidate="txtVendorName" ErrorMessage="required" ForeColor="Red" ValidationGroup="Submitgroup"></asp:RequiredFieldValidator>
            </td>
        </tr>
