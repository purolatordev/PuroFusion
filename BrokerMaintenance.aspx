<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="BrokerMaintenance.aspx.cs" Inherits="BrokerMaintenance" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idBroker" PageSize="25">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditBroker.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idBroker" FilterControlAltText="Filter idBroker column" HeaderText="idBroker" SortExpression="idBroker" UniqueName="idBroker">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="Broker" AllowFiltering="true" FilterControlAltText="Filter Broker column" HeaderText="Broker" SortExpression="Broker" UniqueName="Broker">
                    </telerik:GridBoundColumn>
