...
public partial class CollectionSpecialistMaint : System.Web.UI.Page
{
    ...
    private clsCollectionSpecialist populateObj(UserControl userControl)
    {
        clsCollectionSpecialist oRow = new clsCollectionSpecialist();
