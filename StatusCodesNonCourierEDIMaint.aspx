<%@ Page Language="C#"  MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="StatusCodesNonCourierEDIMaint.aspx.cs" Inherits="StatusCodesNonCourierEDIMaint" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div>
       ...
       <MasterTableView  AutoGenerateColumns="False" AllowPaging="True" EditMode="PopUp" CommandItemDisplay="Top" InsertItemPageIndexAction="ShowItemOnFirstPage" DataKeyNames="idStatusCodesNonCourierEDI">
                <CommandItemSettings ShowExportToExcelButton="True" ShowRefreshButton="False" />
                <EditFormSettings UserControlName="EditStatusCodesNonCourierEDI.ascx" EditFormType="WebUserControl"  PopUpSettings-Height="350px" PopUpSettings-Width="500px">
                ...
                <Columns>
                    ...
                    <telerik:GridBoundColumn DataField="idStatusCodesNonCourierEDI" FilterControlAltText="Filter idStatusCodesNonCourierEDI column" HeaderText="idStatusCodesNonCourierEDI" SortExpression="idStatusCodesNonCourierEDI" UniqueName="idStatusCodesNonCourierEDI">
                    </telerik:GridBoundColumn>
                    <telerik:GridBoundColumn DataField="StatusCode" AllowFiltering="true" FilterControlAltText="Filter Status Code column" HeaderText="Status Code" SortExpression="StatusCode" UniqueName="StatusCode">
                    </telerik:GridBoundColumn>
