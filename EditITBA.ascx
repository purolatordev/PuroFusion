<%@ Control Language="C#" AutoEventWireup="true" CodeFile="EditITBA.ascx.cs" Inherits="EditITBA" %>
...
<asp:Panel ID="Panel1" runat="server" GroupingText=''>
         ...
         <tr>
            ...
            <tr>
                ...
                <td style="width: 150px;">
                    <b>Onboarding Specialist Maintenance </b>
    ...
    <table>
       ...
       <tr>
         ...
         <tr>
            <td style="width: 70px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblEmail" runat="server" CssClass="rdfLabel" Text="Email" /></td>
            <td>
                <telerik:RadTextBox ID="txtEmail" runat="server" Text='<%# Bind("ITBAEmail") %>'  Width="300px" ToolTip="Enter the Email Address"  MaxLength="100">
                </telerik:RadTextBox>
            </td>
            <td>
         ...
         <tr>
            <td style="width: 70px; color:red; text-align:right " >*</td>
            <td ><asp:Label ID="lblLogin" runat="server" CssClass="rdfLabel" Text="Login" /></td>
            <td>
